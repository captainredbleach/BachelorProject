...
\include{0FrontPage/forside}
%\cleardoublepage												% Indsaetter tom side, saa naeste kapitel starter paa hoejre side (hvis noedvendigt)
\include{0FrontPage/titelblad}
%\cleardoublepage
\include{0FrontPage/forord}
%\cleardoublepage 
...
\include{2ProblemAnalysis/ProblemAnalysis}
\include{2ProblemAnalysis/ReqSpec}
\include{3Design/Design}
\include{4Implementation/Implementation}
\include{5Test/Test}
\include{6Discussion&Conclusion/Discussion}
\include{6Discussion&Conclusion/Conclusion}
%%%% Kilder %%%%
...
%\include{7Formalia/Appendixes/appendiks1}
